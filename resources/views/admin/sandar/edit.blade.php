...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-lg-12">
            <div class="card">
                <form action="{{ route('admin.sandar.update',$data['sandar']->id) }}" method="post" enctype="multipart/form-data">
                    <div class="card-body">
                        @csrf
                        ...
                        <div class="row mb-2">
                            <div class="col-md-4">
                                ...
                                <input type="text" name="bongkar" id="bongkar" class="form-control" value="{{$data['sandar']->bongkar->nama}}">
                                <small>cth : Kendaraan, Bungkil, dll</small>    
                            </div>
                            <div class="col-md-4">
                                <label for="jlhbongkar" class="form-label">Jumlah</label>
                                <input type="number" min="0" name="jlhbongkar" id="jlhbongkar" class="form-control" value="{{$data['sandar']->bongkar->jumlah}}">
                            </div>
                            <div class="col-md-4">
                                <label for="stbongkar" class="form-label">Satuan</label>
                                <select name="stbongkar" id="stbongkar" class="form-control">
                                    <option value="0">Pilih Satuan</option>
                                    <option value="m" @if($data['sandar']->bongkar->satuan == 'm') selected @endif >Ton / M/3</option>
                                    <option value="u" @if($data['sandar']->bongkar->satuan == 'u') selected @endif>Unit</option>
                                    <option value="b" @if($data['sandar']->bongkar->satuan == 'b') selected @endif>Box</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row mb-2">
                            <div class="col-md-4">
                                ...
                                <input type="text" name="muat" id="muat" class="form-control" value="{{$data['sandar']->muat->nama}}">
                                <small>cth : Kendaraan, Bungkil, dll</small>    
                            </div>
                            <div class="col-md-4">
                                <label for="jlhmuat" class="form-label">Jumlah</label>
                                <input type="number" min="0" name="jlhmuat" id="jlhmuat" class="form-control" value="{{$data['sandar']->muat->jumlah}}">
                            </div>
                            <div class="col-md-4">
                                <label for="stmuat" class="form-label">Satuan</label>
                                <select name="stmuat" id="stmuat" class="form-control">
                                    <option value="0">Pilih Satuan</option>
                                    <option value="m" @if($data['sandar']->muat->satuan == 'm') selected @endif >Ton / M/3</option>
                                    <option value="u" @if($data['sandar']->muat->satuan == 'u') selected @endif>Unit</option>
                                    <option value="b" @if($data['sandar']->muat->satuan == 'b') selected @endif>Box</option>
                                </select>
                            </div>
                        </div>
                    </div>
